...
volatile u8 tfCardSta = 0x02; // defualt set tf card ok
...
//    iic = new IicMaster(0x43C10000, &gic, XPAR_FABRIC_AXI4LITE_BUFFERED_IIC_MASTER_0_VEC_ID, NULL, NULL, NULL, NULL);
    // daq1245123 addr 0x44A40000
    // daq824208 addr 0x40009000
    iic = new IicMaster(0x44A40000,
    					&Intc,
    ...
    InitMenus();
    DateTime = PCF8563::DT32(21, 4, 23, 0, 0, 0);
    ...
    while(1)
    {
        ...
        else
        {
            ...
            if(0x01 == tfCardSta)
            {
            	sprintf(str, "TF Card Error");
            }
            else
            {
            	sprintf(str, "TF Card Plugin");
