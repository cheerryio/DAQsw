...
fpga -file /home/ubt/xilinx/LNDAQ512k/LNDAQ512k.sdk/ll7a35ek_mbsys_wrapper_hw_platform_0/ll7a35ek_mbsys_wrapper.bit
configparams mdm-detect-bscan-mask 2
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-HS1 210205741823A"} -index 0
rst -system
after 3000
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-HS1 210205741823A"} -index 0
dow /home/ubt/xilinx/LNDAQ512k/LNDAQ512k.sdk/LNDAQ512k/Debug/LNDAQ512k.elf
bpadd -addr &main
