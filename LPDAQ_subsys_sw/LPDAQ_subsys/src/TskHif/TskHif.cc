...
//    iic = new IicMaster(0x43C10000, &gic, XPAR_FABRIC_AXI4LITE_BUFFERED_IIC_MASTER_0_VEC_ID, NULL, NULL, NULL, NULL);
    iic = new IicMaster(XPAR_AXI4LITE_BUFFERED_IIC_BASEADDR, &xInterruptController, XPAR_FABRIC_AXI4LITE_BUFFERED_IIC_IRQ_INTR, NULL, NULL, NULL, NULL);
    ...
    while(1)
    {
        ...
        else
        {
            ...
            if(rtn)
            {
                ...
                printf("%4u-%02u-%02u %02u:%02u:%02u\n\r", DateTime.YearFrom2000 + 2000, DateTime.Month,
                        DateTime.Day, DateTime.Hour, DateTime.Minute, DateTime.Second);
