...
BEGIN OS
 ...
 PARAMETER total_heap_size = 4194304
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ADC0_IQ_Demodulator_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.11
 PARAMETER HW_INSTANCE = ADC0_axi_dma_ADC0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = ADC1_IQ_Demodulator_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.11
 PARAMETER HW_INSTANCE = ADC1_axi_dma_ADC0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi4lite_buffered_iic_master
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi4lite_buffered_ii_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = axi_gpio_reset_fifo
END
