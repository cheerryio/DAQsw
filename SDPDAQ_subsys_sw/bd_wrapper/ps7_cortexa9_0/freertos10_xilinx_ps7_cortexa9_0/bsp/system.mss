...
BEGIN OS
 ...
 PARAMETER max_priorities = 16
 PARAMETER minimal_stack_size = 1024
 PARAMETER stdin = ps7_uart_1
 PARAMETER stdout = ps7_uart_1
 PARAMETER tick_rate = 1000
 PARAMETER total_heap_size = 16777216
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = adc_hier_axi_dma_adc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.7
 PARAMETER HW_INSTANCE = adc_hier_axi_gpio_lastModulo
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.7
 PARAMETER HW_INSTANCE = adc_hier_axi_gpio_resetFifo
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.7
 PARAMETER HW_INSTANCE = adc_hier_axi_gpio_start
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = secCnt
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = adc_hier_secCnt
END
